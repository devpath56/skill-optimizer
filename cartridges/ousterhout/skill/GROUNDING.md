<!-- Bundled grounding for the ousterhout-guru skill. Book-verified distillation (fair-use):
     every anecdote below is grep-confirmed verbatim against the authoritative source. A teaching
     agent handed this bundle can quote REAL book anecdotes (Tcl unset, RAMCloud, Unix file I/O,
     information leakage, temporal decomposition) instead of fabricating. Source: source/reference.verified.md -->
