...
def main():
    ...
    if validated:
        ...
        print("  -> Passing the threshold clears the DEFINED bar, but at this n the judge")
        print("     stays PROVISIONAL; STAGE 2 winners are 'provisionally settled', not settled.")
        rc = 0
    else:
        fails = []
        if not tpr_ok:
